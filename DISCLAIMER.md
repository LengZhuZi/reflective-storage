...
[PolyForm Noncommercial 1.0.0](./LICENSE)：个人学习、研究、教育及非营利使用免费；
**任何形式的商业使用（包括公司内部使用、集成到商业产品、付费服务或 SaaS）都需要单独的
书面商业授权**，见 [LICENSE](./LICENSE)。按原样提供（AS IS），不提供任何担保，使用风险自负。
作者不对数据丢失、模型账单、被注入的内容或任何间接损失负责。
